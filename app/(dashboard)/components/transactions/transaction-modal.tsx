        ...
        <Modal isOpen={isOpen} onClose={onClose} title="Verify Transactions">
            <div className="flex gap-6">
                <div>
                    ...
                    <Image src="/images/payment-proof-dump.png"
                        alt="payment proof" width={200} height={401} />
                </div>
                <div>
                    <div>
                    ...
                    <div className="border border-gray-200 rounded-lg p-4 flex gap-2">
                        <div className="bg-gray-100 rounded-md aspect-square w-8 h-8">
                            <Image src="/images/products/product-3.png" width={30} height={30} alt="product image" />
                        </div>
