...
const CartPopup = () => {
    ...
    return (
        <div className="absolute bg-white right-0 top-12 shadow-xl shadow-black/10 border-gray-200 w-90 z-10">
            ...
            <div className="border-t border-gray-200 p-4">
                ...
                <Button variant="dark" size="small" className="w-full" onClick={handleCheckOut}>Checkout Now <FiArrowRight /></Button>
