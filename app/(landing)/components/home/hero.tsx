         ...
         <section id="hero-section" className="container mx-auto h-screen flex">
            ...
            <div className="relative self-center ">
                <Image
                    ...
                    height={646}
                    alt="image sporton" 
                    className="grayscale absolute left-4 -top-13"/>

                <div className="relative ml-30 w-full">
                    ...
                    <h1 className="font-extrabold text-[85px] italic bg-gradient-to-b leading-tight from-black to-[#979797D1] bg-clip-text text-transparent">
                        WEAR YOUR<br />TOP-QUALITY<br />SPORTSWEAR</h1>
                ...
                <Image
                    ...
                    className="absolute -right-5 top-1/2 -translate-y-1/2 -translate-x-8" />
            </div>
            <Image
