            ...
            <div className="p-5">
                ...
                <div className="border-t border-gray-200 p-4">
                    <div className="flex justify-between">
                        ...
                        <div className="font-semibold text-primary text-xs">{priceFormatter(123000)}</div>
                    </div>
                    <Button variant="dark" size="small" className="w-full" onClick={uploadAndConfirm}><FiCheckCircle />Upload Receipt & Confirm</Button>
                </div>
        </CardWithHeader>
    );
};
